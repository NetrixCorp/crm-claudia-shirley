        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <span className="text-brand-accent font-bold text-sm w-5 flex-shrink-0">1.</span>
            ...
            <div className="flex items-start gap-3">
              <span className="text-brand-accent font-bold text-sm w-5 flex-shrink-0">2.</span>
              <p className="text-slate-500 text-sm">
            ...
            <div className="flex items-start gap-3">
              <span className="text-brand-accent font-bold text-sm w-5 flex-shrink-0">3.</span>
              <p className="text-slate-500 text-sm">
